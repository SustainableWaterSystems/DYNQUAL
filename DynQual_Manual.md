...
`git clone https://github.com/UU-Hydro/SustainableWaterSystems.git`
...
Some example configuration .ini files are provided in the 'ini' directory.
...
`python DynQualModel/deterministic_runner.py <ini_configuration_file>`
